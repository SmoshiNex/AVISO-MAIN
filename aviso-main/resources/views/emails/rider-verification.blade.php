...
<head>
    ...
    <title>Verify Your AVISO Account</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="body">
            <p class="greeting">
                Hi <strong>{{ $firstName }}</strong>, welcome to AVISO!<br><br>
                Use the code below to verify your email address and activate your rider account.
            </p>
            ...
            <div class="warning">
                ...
                If you did not create an AVISO account, you can safely ignore this email.
            </div>
        </div>
